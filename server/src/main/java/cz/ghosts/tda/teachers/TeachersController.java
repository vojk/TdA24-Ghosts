...
public class TeachersController {
    ...
    @PostMapping(path = {"/a/id_lektor", "/a/id_lektor/"})
    public ResponseEntity<Object> getTeacherId(@RequestBody TokenObject entity) {
        DbController dbController = new DbController();
        String teacherId = dbController.getTeacherId(entity.getToken());
        if (teacherId != null) {
