...
function Profil() {
  ...
  if (data) {
    ...
    return (
      <div key={data.UUID} className='vizitka p-5 m-auto overflow-hidden bg-sky rounded-lg grid md:grid-cols-2 grid-cols-1 md:grid-rows-[1fr_auto_auto] grid-rows-[500px_1fr_auto_auto] gap-2'>
